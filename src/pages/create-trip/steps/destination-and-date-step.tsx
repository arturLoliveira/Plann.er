...
export function DestinationAndDateStep({ closeGuestsInput, setDestination, eventStartAndEndDates, setEventStartAndEndDates, isGuestsInputOpen, openGuestsInput }: DestinationAndDateStepProps) {
